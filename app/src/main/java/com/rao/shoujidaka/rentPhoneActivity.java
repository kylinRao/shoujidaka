...
public class rentPhoneActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin()  {
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserLoginTask(phone, name);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserLoginTask(String phone, String name)  {
            mPhone = phone;
            mName = name;

            Log.d("rentPhoneReport", "getNmae " + name);
            Log.d("rentPhoneReport", "getPhone " + phone);
            final String path = "http://192.168.1.105:8888/rentPhoneReport";
            Log.d("rentPhoneReport", "getUrl " + path);
            new Thread() {
                public void run() {
                    try {
                        String data = "phone=" + URLEncoder.encode(mPhone, "utf-8") + "&name=" + URLEncoder.encode(mName, "utf-8");
